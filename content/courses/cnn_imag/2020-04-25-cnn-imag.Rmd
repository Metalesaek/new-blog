...
In this article we will make use of the convolutional neural network, the most widely deep learning method used for image classification, object detection,..etc^[Francois chollet, Deep learning with R, Meap edition, 2017, P112 ]. 
